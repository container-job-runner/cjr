...
import { X11_POSIX_BIND, container_root_label, stack_path_label, project_root_label } from '../constants'
...
{
  if(projectRoot) configuration.addLabel(project_root_label, projectRoot)
