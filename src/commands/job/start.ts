...
export class Start extends JobCommand {
  ...
  static flags = {
    ...
    "autocopy": flags.boolean({default: false, exclusive: ["async"], description: "automatically copy files back to the project root on exit"}),
    "no-autocopy": flags.boolean({default: false, exclusive: ["async"], description: "do not copy files back to the project root on exit"}),
